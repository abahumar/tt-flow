...
INSERT INTO "new_VideoJob" ("createdAt", "errorMessage", "id", "imageOnly", "imagePrompt", "imageUrl", "lastError", "maxRetries", "productId", "referenceImage", "referenceImages", "retryCount", "startedAt", "status", "templateId", "tiktokCaption", "tiktokDescription", "tiktokHashtags", "tiktokPostUrl", "tiktokProductName", "updatedAt", "videoPrompt", "videoType", "videoUrl") SELECT "createdAt", "errorMessage", "id", "imageOnly", "imagePrompt", "imageUrl", "lastError", "maxRetries", "productId", "referenceImage", "referenceImages", "retryCount", "startedAt", "status", "templateId", "tiktokCaption", "tiktokDescription", "tiktokHashtags", "tiktokPostUrl", "tiktokProductName", "updatedAt", "videoPrompt", "videoType", "videoUrl" FROM "VideoJob";
DROP TABLE "VideoJob";
