...
CREATE TABLE "VideoTemplate" (
    ...
    "backgroundDesc" TEXT NOT NULL DEFAULT '',
    "modelImage" TEXT NOT NULL DEFAULT '',
    "modelDesc" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_VideoJob" ("createdAt", "errorMessage", "id", "imageOnly", "imagePrompt", "imageUrl", "lastError", "maxRetries", "productId", "referenceImage", "retryCount", "startedAt", "status", "tiktokCaption", "tiktokDescription", "tiktokHashtags", "tiktokPostUrl", "tiktokProductName", "updatedAt", "videoPrompt", "videoType", "videoUrl") SELECT "createdAt", "errorMessage", "id", "imageOnly", "imagePrompt", "imageUrl", "lastError", "maxRetries", "productId", "referenceImage", "retryCount", "startedAt", "status", "tiktokCaption", "tiktokDescription", "tiktokHashtags", "tiktokPostUrl", "tiktokProductName", "updatedAt", "videoPrompt", "videoType", "videoUrl" FROM "VideoJob";
DROP TABLE "VideoJob";
