...
INSERT INTO "new_VideoJob" ("createdAt", "errorMessage", "groupId", "id", "imageOnly", "imagePrompt", "imageUrl", "lastError", "masterJobId", "maxRetries", "productId", "referenceImage", "referenceImages", "retryCount", "sceneIndex", "startedAt", "status", "templateId", "tiktokCaption", "tiktokDescription", "tiktokHashtags", "tiktokPostUrl", "tiktokProductName", "updatedAt", "videoPrompt", "videoType", "videoUrl") SELECT "createdAt", "errorMessage", "groupId", "id", "imageOnly", "imagePrompt", "imageUrl", "lastError", "masterJobId", "maxRetries", "productId", "referenceImage", "referenceImages", "retryCount", "sceneIndex", "startedAt", "status", "templateId", "tiktokCaption", "tiktokDescription", "tiktokHashtags", "tiktokPostUrl", "tiktokProductName", "updatedAt", "videoPrompt", "videoType", "videoUrl" FROM "VideoJob";
DROP TABLE "VideoJob";
