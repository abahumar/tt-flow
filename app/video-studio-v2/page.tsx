      ...
      <div className="space-y-4 rounded-xl border border-gray-200 bg-white p-5">
        ...
        <div>
          <button
            ...
            className={`w-full rounded-xl border py-2.5 text-xs font-bold transition-all ${isClothing ? "border-pink-500 bg-pink-500 text-white shadow-md" : "border-gray-200 bg-white text-gray-500 hover:border-gray-300"}`}
          >
